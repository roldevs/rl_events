...
class RLEvents_GameDataMembers {
  ...
  protected function data() {
    return array(
      ...
      'Di0pter' => ['di0pter#1507', 'di0pter'],
      'Divad' => ['divad#3865', 'dlnonell'],
      ...
      'Joanna Devas' => ['joannadevas#7944', 'joannadevas'],
      ...
      'Lucía' => ['lucía#2598', 'lucia131', 'Lucia #2598', 'lucia#2598'],
      ...
      'Ágatha' => ['mokuren#9638', 'agatha.armstrong', 'Agatha Armstrong', 'Agatha'],
      'Mr. Bergamot' => ['mrbergamot#4120', 'mrbergamot'],
      'Nai' => ['nai#0930', 'nai'],
